...
public class CasterCuriosBonusConfig {
    ...
    // Voidsnare
    // ==============================
    public static ModConfigSpec.DoubleValue VoidsnareMinDropTeleportingRadius;
    public static ModConfigSpec.BooleanValue VoidsnareSpellDamageIsNecessary;

    // ==============================
    // calamity resonator
    // ==============================
    public static ModConfigSpec.DoubleValue calamityResonatorSplashPercent;
    public static ModConfigSpec.DoubleValue calamityResonatorSplashRadius;
    public static ModConfigSpec.IntValue calamityResonatorCooldownTicks;
